               ...
               <div className='col-lg-6 border rounded bg-white m-2 w-75'>
                    ...
                    <div className='row'>
                        <div className='d-flex justify-content-end p-2'>
                            ...
                            <button className='btn btn-success m-2' onClick={()=>{handleAccept(data.order_id, data.uid, data.rid, data.address, data.user_lat, data.user_long, data.cart, data.cart_total)
